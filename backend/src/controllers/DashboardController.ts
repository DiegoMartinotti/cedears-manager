...
export class DashboardController {
   ...
   */
  async getCurrentPositions(req: Request, res: Response): Promise<void> {
    try {
   ...
   */
  async getMarketSummary(req: Request, res: Response): Promise<void> {
    try {
   ...
   */
  async getDistributionData(req: Request, res: Response): Promise<void> {
    try {
