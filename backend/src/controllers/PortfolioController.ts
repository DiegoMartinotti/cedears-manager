...
import {
  ...
  PortfolioPositionParamsSchema,
  PortfolioPositionInstrumentParamsSchema
...
export class PortfolioController {
  ...
  async getPortfolioPositions(req: Request, res: Response): Promise<void> {
    try {
  ...
  async getPortfolioPosition(req: Request, res: Response): Promise<void> {
    try {
  ...
  async getPortfolioPositionByInstrument(req: Request, res: Response): Promise<void> {
    try {
  ...
  async createPortfolioPosition(req: Request, res: Response): Promise<void> {
    try {
  ...
  async updatePortfolioPosition(req: Request, res: Response): Promise<void> {
    try {
  ...
  async deletePortfolioPosition(req: Request, res: Response): Promise<void> {
    try {
  ...
  async processTradeAndUpdatePosition(req: Request, res: Response): Promise<void> {
    try {
  ...
  async calculateRebalancing(req: Request, res: Response): Promise<void> {
    try {
