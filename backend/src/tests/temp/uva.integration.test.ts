...
describe('UVA Integration Tests', () => {
  ...
  describe('UVA Controller Integration', () => {
    ...
    it('should handle getStatistics endpoint', async () => {
      ...
      await uvaController.getStatistics(mockRequest as Request, mockResponse as Response)
    ...
    it('should handle calculateInflationAdjustment endpoint', async () => {
      ...
      await uvaController.calculateInflationAdjustment(mockRequest as Request, mockResponse as Response)
  ...
  describe('Error Handling', () => {
    ...
    it('should handle missing UVA data for calculations', async () => {
      ...
      try {
        ...
        expect(error).toBeInstanceOf(Error)
        expect((error as Error).message).toContain('UVA values not found')
      }
    })
  })
