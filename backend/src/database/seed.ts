  ...
  try {
    ...
    try {
      ...
      if (existingConfig) {
        ...
        stmt.run(
          sampleCommissionConfig.broker_name,
          sampleCommissionConfig.commission_rate,
          sampleCommissionConfig.minimum_commission,
          sampleCommissionConfig.market_tax_rate,
          sampleCommissionConfig.iva_rate,
          sampleCommissionConfig.is_active ? 1 : 0,
          sampleCommissionConfig.effective_from
        )
