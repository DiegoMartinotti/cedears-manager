...
export class PortfolioService {
    portfolioModel = new PortfolioPosition();
    ...
    async getPortfolioPositionByInstrument(instrumentId) {
    ...
    async createPortfolioPosition(data) {
    ...
    async updatePortfolioPosition(id, data) {
    ...
    async deletePortfolioPosition(id) {
    ...
    async processTradeAndUpdatePosition(tradeData) {
    ...
    calculateNewPosition(currentPosition, trade) {
    ...
    async closePosition(instrumentId) {
