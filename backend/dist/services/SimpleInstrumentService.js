import { SimpleInstrument } from '../models/SimpleInstrument.js';
import { createLogger } from '../utils/logger.js';
const logger = createLogger('SimpleInstrumentService');
export class SimpleInstrumentService {
    instrumentModel = new SimpleInstrument();
    ...
    async searchInstruments(searchTerm) {
    ...
    async bulkCreateInstruments(instruments) {
...
//# sourceMappingURL=SimpleInstrumentService.js.map