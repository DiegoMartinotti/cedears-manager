...
Amount: $$;
{
    exemptCustody.applicableAmount.toLocaleString();
}
`)
  console.log(`;
Monthly;
Fee: $$;
{
    exemptCustody.monthlyFee.toFixed(2);
}
`)
  console.log(`;
Annual;
Fee: $$;
{
    exemptCustody.annualFee.toFixed(2);
}
`)
...
Amount: $$;
{
    nonExemptCustody.applicableAmount.toLocaleString();
}
`)
  console.log(`;
Monthly;
Fee: $$;
{
    nonExemptCustody.monthlyFee.toFixed(2);
}
`)
  console.log(`;
IVA: $$;
{
    nonExemptCustody.ivaAmount.toFixed(2);
}
`)
  console.log(`;
Total;
...
Cost: $$;
{
    nonExemptCustody.totalMonthlyCost.toFixed(2);
}
`)
  console.log(`;
Annual;
Fee: $$;
{
    nonExemptCustody.annualFee.toFixed(2);
}
`)
...
$;
{
    nonExemptCustody.applicableAmount;
}
`)
  }
...
nBreak - even;
analysis;
for ($$; { investment, : .toLocaleString() }; investment)
    : `)
  console.log(`;
Buy;
Commission: $$;
{
    buyCommission.totalCommission.toFixed(2);
}
`)
  console.log(`;
Sell;
Commission: $$;
{
    sellCommission.totalCommission.toFixed(2);
}
`)
...
impact: $;
{
    (breakEvenPercentage + custodyImpact).toFixed(2);
}
 % `)
}
...
t$$;
{
    commission.totalCommission.toFixed(0);
}
t;
t$;
{
