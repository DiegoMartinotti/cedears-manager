...
import { convertToConstantPesos, calculatePurchasingPower, calculateRealReturn, calculateAccumulatedInflation, formatInflationAdjustedAmount } from '../utils/uvaHelpers.js';
...
describe('UVA Model', () => {
    ...
    describe('calculateInflationAdjustment', () => {
        ...
        it('should throw error for missing UVA data', async () => {
            const amount = 1000;
            await expect(uva.calculateInflationAdjustment(amount, '2023-01-01', '2023-01-31')).rejects.toThrow();
        });
    });
