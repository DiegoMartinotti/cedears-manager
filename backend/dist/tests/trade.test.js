...
describe('TradeService', () => {
    ...
    describe('Commission Projections', () => {
        it('should project total first year cost correctly', () => {
            const result = commissionService.calculateCommissionProjection('BUY', 50000, // Operación de $50k
            ...
            expect(result.totalFirstYearCost).toBe(result.operation.totalCommission + result.custody.annualFee);
        ...
        it('should calculate break-even impact percentage correctly', () => {
            ...
            const result = commissionService.calculateCommissionProjection('BUY', operationAmount, 500000, // Bajo el límite de custodia
            commissionService.getDefaultConfiguration());
    ...
    describe('Minimum Investment Calculation', () => {
        it('should calculate minimum investment for 2% commission threshold', () => {
            const result = commissionService.calculateMinimumInvestmentForCommissionThreshold(2.0, // 2% threshold
            commissionService.getDefaultConfiguration());
    ...
    describe('Broker Comparison', () => {
        it('should compare brokers and rank by total cost', () => {
            const comparison = commissionService.compareBrokerCommissions('BUY', 100000, // $100k operation
            ...
            for (let i = 1; i < comparison.length; i++) {
                expect(comparison[i].totalFirstYearCost).toBeGreaterThanOrEqual(comparison[i - 1].totalFirstYearCost);
...
describe('Integration Tests', () => {
    ...
    describe('Real-world Scenarios', () => {
        it('should calculate realistic commission for typical CEDEAR purchase', () => {
            ...
            const projection = commissionService.calculateCommissionProjection('BUY', operationAmount, portfolioValue);
        ...
        it('should identify best broker for different scenarios', () => {
            ...
            scenarios.forEach(scenario => {
                const comparison = commissionService.compareBrokerCommissions('BUY', scenario.operation, scenario.portfolio);
                expect(comparison.length).toBeGreaterThan(1);
    ...
    describe('Performance Tests', () => {
        it('should calculate commissions quickly for batch operations', () => {
            ...
            for (let i = 0; i < 100; i++) {
                commissionService.calculateOperationCommission('BUY', Math.random() * 100000 + 10000 // Entre $10k y $110k
                );
            }
        ...
        it('should handle large broker comparisons efficiently', () => {
            ...
            for (let i = 0; i < 50; i++) {
                commissionService.compareBrokerCommissions('BUY', Math.random() * 200000 + 20000, Math.random() * 3000000 + 500000);
            }
            const endTime = Date.now();
            const executionTime = endTime - startTime;
