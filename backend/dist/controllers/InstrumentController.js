...
import { InstrumentCreateSchema, InstrumentUpdateSchema, InstrumentQuerySchema, InstrumentParamsSchema } from '../schemas/instrument.schema.js';
const logger = createLogger('InstrumentController');
export class InstrumentController {
    instrumentService = new SimpleInstrumentService();
    ...
    async getAllInstruments(req, res) {
        try {
    ...
    async getESGInstruments(req, res) {
        try {
    ...
    async getVeganInstruments(req, res) {
        try {
    ...
    async toggleESGCompliance(req, res) {
        try {
    ...
    async toggleVeganFriendly(req, res) {
        try {
    ...
    async bulkCreateInstruments(req, res) {
        try {
            ...
            const validatedInstruments = instruments.map(instrument => InstrumentCreateSchema.parse(instrument));
