// Script simple para ejecutar la migración del optimizador
const Database = require('better-sqlite3');
const path = require('path');

console.log('Ejecutando migración 022...');

try {
  // Abrir base de datos
  const dbPath = path.join(__dirname, 'backend/database/cedears.db');
  const db = new Database(dbPath);
  
  console.log('✅ Base de datos abierta');

  // Crear tablas del optimizador
  db.exec(`
  ...
  console.log('✅ Tablas del optimizador creadas exitosamente');
